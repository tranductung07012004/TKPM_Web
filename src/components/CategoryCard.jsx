...
const CategoryCard = ({ icon, title, description, buttonText }) => {
  return (
    <div className="flex flex-row justify-between items-center text-center bg-[#e8d9e6] backdrop-blur-lg rounded-xl p-6">
      ...
      <div className="">      
        ...
        <button className="mt-auto w-48 truncate bg-white/80 text-[#5201FF] px-4 py-2 rounded-full hover:bg-[#d39ccb]">
          {buttonText}
